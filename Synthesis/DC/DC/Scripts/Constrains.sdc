...
# A 370MHz clock is a 10000.0ns period:
#
create_clock -period 15 -name clk -waveform {0 7.5} [get_ports clk]
...
# The maximum clock transition is ???ps or 0.1ns
#
...
#
#set_driving_cell -lib_cell 0.025 -library slow [get_ports -filter "@port_direction == in"]
